                ...
                .then(async (jsonObj) => {
                        ...
                        for (let index = 0; index < jsonObj.length; index++) {
                            dataObj.push({
                                ...
                                "firstName": jsonObj[index]['FIRST NAME'],
                                "lastName": jsonObj[index]['LAST NAME'],
                                country: {
                                    isocode: "US",
                                    name: 'United States'
                                },
                                region: {
                                    countryIso: 'US',
                                    isocode: 'US-' + jsonObj[index]['STATE CODE'],
                                    isocodeShort: jsonObj[index]['STATE CODE'],
                                    name: jsonObj[index]['STATE NAME'],
                                },
                                "line1": jsonObj[index]['ADDRESS LINE 1'],
                                "line2": jsonObj[index]['ADDRESS LINE 2'],
                                "postalCode": jsonObj[index]['ZIP'],
                                "town": jsonObj[index]['CITY'],
                                "phone": jsonObj[index]['PHONE NUMBER'],
                                "email": jsonObj[index]['EMAIL'],
                                "profile_name": jsonObj[index]['PROFILE NAME'],
                                billing: {
                                    "firstName": jsonObj[index]['FIRST NAME'],
                                    "lastName": jsonObj[index]['LAST NAME'],
                                    country: {
                                ...
                                card: {
                                    number: jsonObj[index]['CARD NUMBER'],
                                    month: jsonObj[index]['EXPIRY MONTH'],
                                    year: jsonObj[index]['EXPIRY YEAR'],
                                    cvv: jsonObj[index]['CVV'],
                                    // cardType: card_type,
                                    cardHolderName: jsonObj[index]['CARD HOLDER NAME']
                                }
                                // ,CARD NUMBER,EXPIRY MONTH,EXPIRY YEAR,CVV
                            })
                        }
                        await this.createBulkProfile(dataObj)
                    }
                )
        })
    };
    ...
    render() {
        ...
        return (
            <Container fluid className="d-flex p-l-0 p-r-0">
                {this.ProfileModal()}
                <Toaster loader={bulkUploadLoader} context={this} showToast={showToast} message={apiMessage}
                ...
                <div className="right-side">
                    ...
                    <Headingtop text="PROFILES"/>

                    <div className="blue-bg">
                        <SubHeaderMenu
                            openAddBulkProfileModal={() => this.openAddBulkProfileModal()}
                            onDeleteAllProfile={() => this.deleteAllProfiles()}
                            openProfileModal={() => {
            ...
            <Modal
                ...
                <form id='taskaddForm' onSubmit={(e) => {
                    ...
                    <Modal.Body>
                        ...
                        <span
                            className='c-task-header sub-heading-color f-w-700'>{isUpdatingProfile ? "Update " : "Create "}Profile</span>
                        ...
                        {ship ? <div id={'shipping'}>
                            ...
                            <Row style={{marginTop: 15}}>
                                <Col>
                                    <input
                                        ...
                                        value={ship_email}
                                        name='ship_email'
                                        style={{background: '#3A2B2B', color: '#fff'}} type="email" required={true}
                                        placeholder="Email"
                                        className="input-box-color"/>
                                </Col>
                                <Col>
                                ...
                                <Col>
                                    <Form.Group controlId="exampleForm.ControlSelect1">
                                        <Form.Control className="input-box-color"
                                            ...
                                            <option selected
                                                    value='-1'>{isLoadingStates ? "Loading.." : "States"}</option>
                            ...
                            <Row style={{marginTop: 0, paddingBottom: 20}}>
                                <Col>
                                    <input
                                        onChange={(e) => this.handleInputChange(e)}
                                        value={ship_city}
                        ...
                        {bill ? <div id={'billing'}>
                            ...
                            <Row style={{marginTop: 0, paddingBottom: 35}}>
                                <Col>
                                    <input
                                        onChange={(e) => this.handleInputChange(e)}
                                        value={bill_city}
