...
export default class Captcha extends Component {
    ...
    fetchCaptchaDataFromDb(userObj) {
        ...
        let appID = userObj.user[0].app_id;
        let context = this;
        console.log(Constant.BASE_URL + Constant.API_ENDPOINTS.CAPTCHA_DATA + '?filter[where][app_id]=' + appID + '&access_token=' + accessToken)
        ...
        return (
            <Modal
                ...
                <form id='taskaddForm' onSubmit={(e) => {
                    ...
                    <Modal.Body>
                        <span
                            className='c-task-header sub-heading-color f-w-700'>Captcha</span>
                        ...
                        <div id={'card'}>
                            ...
                            <Row style={{marginTop: 15, paddingBottom: 0}}>
                                <Col>
                                    <Form.Group controlId="exampleForm.ControlSelect1">
                                        <Form.Control className="input-box-color"
                                                      onChange={(e) => this.handleInputChange(e)}
                                                      name='account'
                                                      value={account} as="select">
                                ...
                                <Col>
                                    <Form.Group controlId="exampleForm.ControlSelect1">
                                        <Form.Control className="input-box-color"
                                                      onChange={(e) => this.handleInputChange(e)}
                                                      name='captchaType'
                                                      value={captchaType} as="select">
                                            <option selected value='-1'>Captcha type</option>
                                ...
                                <Col>
                                    <Form.Group controlId="exampleForm.ControlSelect1">
                                        <Form.Control className="input-box-color"
                                                      onChange={(e) => this.handleInputChange(e)}
                                                      name='showWindow'
                                                      value={showWindow} as="select">
                                            <option selected value='0'>Show Captcha Window</option>
    ...
    _renderEmptyCaptcha() {
        return (
            <Col className='sub-container-background' md={4}>
                <div style={{alignSelf: 'center', display: 'grid'}}>
                    <span className='main-heading-color2'>Add Solver</span>
                    <ul>
                        <li className='open-solver-btn'>
                            <DefaultButton1 onClick={() => this.setState({modalShow: true})}
                                            text="Add"
                                            styles={{
                                                margin: '0 auto',
                                                width: undefined,
    ...
    _renderCaptcha(data, index) {
        return (
            ...
            <Col className='sub-container-background' key={index} md={4}>
                <div>
                    ...
                    <input type="text" placeholder="Proxy"
                           className="input-box-color" disabled={true} value={data.proxy}/>

                    <span style={{marginTop: 10}} className="main-heading-color2">Captcha {data.captchaType}</span>

                    <ul>
                        <li className='yt-btn'>
                            <DefaultButton1 onClick={() => this.openYoutube(data.accountID, data.proxy)} text="Youtube"
                                            styles={{
                                                margin: '0 auto',
                                                width: undefined,
                                                fontSize: 14,
                ...
                <div className="right-side">
                    ...
                    <div className="blue-bg">
                        ...
                        <Row className='captcha-main-container main-background' style={{height: contentHeight}}>
                            ...
                            <Col lg={8} style={{marginLeft: 0, marginRight: 0}}>

                                <Row style={{marginLeft: 0, marginRight: 0, marginTop: 20, marginBottom: 10}}>
                                    {
                            ...
                            <Col lg={4} style={{backgroundColor: 'transparent'}}>
